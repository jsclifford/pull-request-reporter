...
parser.add_argument(
    '-r', '--repository', help='Repository to retrieve pull requests from', action='store', required=True)
parser.add_argument(
    '-e', '--email', help='Email to send pull request summary to', action='store', required=True)
parser.add_argument(
...
send_email.send("crazyspammer@kazisolutions.com", args.email,
                f"Pull Request Summary for Repo: github.com/{args.repository}", html_body)
